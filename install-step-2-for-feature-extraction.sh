...
# Zhao, Xiaofei (2025). MullerNCItrain_.train-data.min.tsv. figshare. Dataset. https://doi.org/10.6084/m9.figshare.28745798.v2
mkdir -p ${rootdir}/model && wget -c https://figshare.com/ndownloader/files/55106327 && cp 55106327 ${rootdir}/model/MullerNCItrain_.train-data.min.tsv
