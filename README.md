...
By default, the pipeline also generates fusion and splicing variants because in the config.yaml file alteration_type='snv,indel,fsv,fusion,splicing'. 
The fusion and splicing variants are generated by star-fusion and ASNEO. 
