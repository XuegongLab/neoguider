...
trained_model = F'{script_basedir}/model/MullerNCItrain_.peplen_train_8to11.default.pickle'
...
rule Model_training:
    ...
    run:
        shell('python {script_basedir}/neopredictor.py --model {trained_model} --peplens 8,9,10,11 --train {traindata_tsv} {prio_alteration_type_cmdline_param}')
